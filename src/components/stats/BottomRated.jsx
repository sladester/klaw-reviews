// src/components/stats/BottomRated.jsx
import { useState } from 'react'
import { bottomRated } from '../../lib/stats'

export default function BottomRated({ drinks, goToList }) {
  const [expanded, setExpanded] = useState(false)
  const data = bottomRated(drinks)
  ...
  return (
    ...
    >
      <h2 className="text-lg font-bold mb-3" style={{ color: 'var(--accent-primary)' }}>
        Bottom Rated <span className="text-sm font-normal" style={{ color: 'var(--text-muted)' }}>(hall of shame)</span>
      </h2>
          ...
          <li key={d._row}>
            ...
            >
              <span className="min-w-0 flex-1">
                <span className="font-bold mr-2" style={{ color: '#dc2626' }}>
                  {d.ratings.overall}
                </span>
